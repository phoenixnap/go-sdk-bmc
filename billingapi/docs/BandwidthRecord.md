...
`func NewBandwidthRecord(id string, productCategory RatedUsageProductCategoryEnum, productCode string, location LocationEnum, startDateTime time.Time, endDateTime time.Time, cost int64, priceModel string, unitPrice float32, unitPriceDescription string, quantity float32, active bool, metadata BandwidthDetails, ) *BandwidthRecord`
...
`func (o *BandwidthRecord) HasUsageSessionId() bool`
...
`func (o *BandwidthRecord) HasCorrelationId() bool`
...
`func (o *BandwidthRecord) GetReservationDetails() ReservationDetails`

GetReservationDetails returns the ReservationDetails field if non-nil, zero value otherwise.

### GetReservationDetailsOk

`func (o *BandwidthRecord) GetReservationDetailsOk() (*ReservationDetails, bool)`
...
`func (o *BandwidthRecord) SetReservationDetails(v ReservationDetails)`

SetReservationDetails sets ReservationDetails field to given value.

### HasReservationDetails

`func (o *BandwidthRecord) HasReservationDetails() bool`
