...
// checks if the BandwidthRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BandwidthRecord{}
...
type NullableBandwidthRecord struct {
	value *BandwidthRecord
	isSet bool
}

func (v NullableBandwidthRecord) Get() *BandwidthRecord {
	return v.value
}

func (v *NullableBandwidthRecord) Set(val *BandwidthRecord) {
	v.value = val
	v.isSet = true
}
...
func NewNullableBandwidthRecord(val *BandwidthRecord) *NullableBandwidthRecord {
	return &NullableBandwidthRecord{value: val, isSet: true}
}
